...
<head>
    ...
    <style>
        ...
        body {
            background: url("https://ts1.cn.mm.bing.net/th/id/R-C.7bcf15a6f2a8b5e99e25961f29a571ed?rik=stXP6%2f%2bNRvPKyg&riu=http%3a%2f%2fimage.nbd.com.cn%2fuploads%2farticles%2fimages%2f960573%2f__________-501435354.jpg&ehk=fdg80ummg3PHjMAZRf8oj2fGOWkA%2b6%2bFhtE26M7WmT0%3d&risl=&pid=ImgRaw&r=0");
            background-size: 100%;
        }
            ...
            <form class="layui-form" action="" lay-filter="loginForm">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="username" name="username" lay-verify="required|account"
                           placeholder="学号、职工号、管理员用户名" autocomplete="off" class="layui-input" value="admin">
                </div>
                <%--密码--%>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" id="captcha" name="captcha" lay-verify="required|captcha"
                ...
                <div class="layui-form-item">
                    <input type="checkbox" id="rememberMe" name="rememberMe" value="true" lay-skin="primary"
                           title="记住密码（一周有效）"> <%--选中为true，没选中没有--%>
                </div>
                <div class="layui-form-item">
